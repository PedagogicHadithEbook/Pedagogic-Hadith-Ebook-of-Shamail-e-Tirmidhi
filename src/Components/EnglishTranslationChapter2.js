...
export default function EnglishTranslationChapter2() {
  const navigate = useNavigate();
  
  const EnglishTranslationChapter3 = () => {
      navigate('/EnglishTranslationChapters/EnglishTranslationChapter3')
  }

 const loop2=[14,15,16,17,18,19,20,21]
...
const copyToClipboard = (loop) => {
  ...
  return (
    ...
    <center><h2>Chapter 2. Seal Of Nubuwwah (Prophethood) Of Rasoolullah</h2> </center>
    ...
    {/* eslint-disable-next-line */}
      <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter2' +'/#Hadith'+(loop+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
      {/* eslint-disable-next-line */}
      <h6><HashLink to={'/WordToWordTranslationChapters/WordToWordTranslationChapter2' +'/#Hadith'+(loop+1)} style={{ color:"midnightblue"}}>View Word-By-Word Grammar</HashLink></h6>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {EnglishTranslationChapter3} >View Next Chapter{'>>'}</button>
           </div>
