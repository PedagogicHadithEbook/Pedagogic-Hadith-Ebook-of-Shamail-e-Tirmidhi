...
export default function EnglishTranslationChapter49() {
  const navigate = useNavigate();
  
  const EnglishTranslationChapter50 = () => {
      navigate('/EnglishTranslationChapters/EnglishTranslationChapter50')
  }
...
const copyToClipboard = (loop) => {
  ...
  return (
    ...
    {/* eslint-disable-next-line */}
      <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter49' +'/#Hadith'+(loop+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
      {/* eslint-disable-next-line */}
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {EnglishTranslationChapter50} >View Next Chapter{'>>'}</button>
           </div>
