...
export default function EnglishTranslationChapter39() {
  const navigate = useNavigate();
  
  const EnglishTranslationChapter40 = () => {
      navigate('/EnglishTranslationChapters/EnglishTranslationChapter40')
  }

 const loop39=[243,244,245,246,247,248,249,250,251,252,253,254,255,256,257,258,259,260,261,262,263,264,265,266]
...
const copyToClipboard = (loop) => {
  ...
  return (
    ...
    <center><h2>Chapter 39. Worship And Devotion Of Rasoolullah</h2></center>

    {
      loop39.map((loop,index) => (  
    ...
    {/* eslint-disable-next-line */}
      <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter39' +'/#Hadith'+(loop+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
      {/* eslint-disable-next-line */}
      <h6><HashLink to={'/WordToWordTranslationChapters/WordToWordTranslationChapter39' +'/#Hadith'+(loop+1)} style={{ color:"midnightblue"}}>View Word-By-Word Grammar</HashLink></h6>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {EnglishTranslationChapter40} >View Next Chapter{'>>'}</button>
           </div>
