...
export default function EnglishTranslationChapter22() {
  const navigate = useNavigate();
  
  const EnglishTranslationChapter23 = () => {
      navigate('/EnglishTranslationChapters/EnglishTranslationChapter23')
  }

 const loop22=[122,123,124,125]
...
const copyToClipboard = (loop) => {
  ...
  return (
    ...
    {/* eslint-disable-next-line */}
      <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter22' +'/#Hadith'+(loop+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
     {/* eslint-disable-next-line */}
      <h6><HashLink to={'/WordToWordTranslationChapters/WordToWordTranslationChapter22' +'/#Hadith'+(loop+1)} style={{ color:"midnightblue"}}>View Word-By-Word Grammar</HashLink></h6>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {EnglishTranslationChapter23} >View Next Chapter{'>>'}</button>
           </div>
