...
export default function UrduTranslationChapter38() {
  
  const navigate = useNavigate();
  
  const UrduTranslationChapter39 = () => {
      navigate('/UrduTranslationChapters/UrduTranslationChapter39')
  }
 ...
 const loop38=[237,238,239,240,241,242]
  return (
    ...
    <RWebShare
      ...
      {/* eslint-disable-next-line */}
      <h6><HashLink to={"/EnglishTranslationChapters/EnglishTranslationChapter38"+"/#Hadith"+(loop+1)} style={{ color:"midnightblue"}}>View English Translation</HashLink></h6>
       {/* eslint-disable-next-line */}
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {UrduTranslationChapter39} >View Next Chapter{'>>'}</button>
           </div>
   </>
  )
}
