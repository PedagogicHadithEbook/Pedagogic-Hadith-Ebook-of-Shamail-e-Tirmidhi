...
export default function EnglishTranslationChapter29() {
  const navigate = useNavigate();
  
  const EnglishTranslationChapter30 = () => {
      navigate('/EnglishTranslationChapters/EnglishTranslationChapter30')
  }
 ...
 const loop29=[184,185]
  return (
    <>
    

    <center><h1>English Translation</h1></center><br />
    <center><h2>Chapter 29. The Cup Of Rasoolullah</h2> </center>

    {
      loop29.map((loop,index) => (  
    ...
    {/* eslint-disable-next-line */}
      <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter29' +'/#Hadith'+(loop+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
      {/* eslint-disable-next-line */}
      <h6><HashLink to={'/WordToWordTranslationChapters/WordToWordTranslationChapter29' +'/#Hadith'+(loop+1)} style={{ color:"midnightblue"}}>View Word-By-Word Grammar</HashLink></h6>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {EnglishTranslationChapter30} >View Next Chapter{'>>'}</button>
           </div>
