...
export default function WordToWordTranslationChapter1() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter2 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter2')
  } 
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 1. The Noble Features Of Rasoolullah</h2><br /></center>
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <div className="container1">{WordByWordGrammerChecBox(hadith1[loop1].Sindexlafz,hadith1[loop1].Eindexlafz,loop1) }
         <br />
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter1' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter1' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
        ...
        <div>
         ...
         Sindex : is Startindex used in EnglishUrduTranslation.json for next hadith start index used in lafz.json 
         while Eindex for next hadith closing index , So data of specific hadith in lafz.json is shown*/}
         <div className="container1">{WordByWordGrammer(hadith1[loop1].Sindexlafz,hadith1[loop1].Eindexlafz,loop1) }
         <br />
         <div className="Reference1">
           <p><b>Reference: </b>{HadithRef[loop1].Reference}<br />
           <b>In-book reference: </b>{HadithRef[loop1].Book_Reference}</p>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter2} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
