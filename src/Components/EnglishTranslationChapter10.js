...
export default function EnglishTranslationChapter10() {
  const navigate = useNavigate();
  
  const EnglishTranslationChapter11 = () => {
      navigate('/EnglishTranslationChapters/EnglishTranslationChapter11')
  }
...
const copyToClipboard = (loop) => {
  ...
  return (
    ...
    {/* eslint-disable-next-line */}
      <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter10' +'/#Hadith'+(index+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
     {/* eslint-disable-next-line */}
      <h6><HashLink to={'/WordToWordTranslationChapters/WordToWordTranslationChapter10' +'/#Hadith'+(loop+1)} style={{ color:"midnightblue"}}>VView Word-By-Word Grammar</HashLink></h6>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {EnglishTranslationChapter11} >View Next Chapter{'>>'}</button>
           </div>
